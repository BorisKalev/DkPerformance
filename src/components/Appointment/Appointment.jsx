        ...
        <div>
          ...
          <ul className="mt-7 flex flex-col gap-3 list-none">
            {[
              ...
              "Transparent quoting — no surprises",
              "Track & street builds welcome",
            ].map((perk) => (
              <li
                key={perk}
                className="relative pl-5 text-sm text-muted before:content-['—'] before:absolute before:left-0 before:text-accent"
              >
                {perk}
              </li>
            ))}
        ...
        >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              name="vehicle"
              type="text"
              placeholder="2018 Subaru WRX STI"
              className="field-input"
              value={form.vehicle}
              onChange={handleChange}
            />
